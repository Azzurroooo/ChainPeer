"""Filesystem-backed Quanora skill repository."""
...
class SkillRepository:
    ...
    def __init__(
        ...
        self._project_skill_dir = Path(project_skill_dir).expanduser().resolve() if project_skill_dir else self._project_root / ".quanora" / "skills"
        self._user_skill_dir = Path(user_skill_dir).expanduser().resolve() if user_skill_dir else self._user_home / ".quanora" / "skills"
