...
def skill_create(
    ...
    """Create a well-formed Quanora SKILL.md in the project or user skill directory."""
    try:
        ...
        root = Path.cwd() / ".quanora" / "skills" if normalized_scope == "project" else Path.home() / ".quanora" / "skills"
